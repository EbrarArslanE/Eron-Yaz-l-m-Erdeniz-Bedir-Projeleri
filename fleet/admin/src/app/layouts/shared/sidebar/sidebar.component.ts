...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    // initialize() fonksiyonunda MetisMenu zaten initialize ediliyor
  }
  ...
  async ipAl(): Promise<void> {
    const responseData: any = await this.islem.WebServisSorguSonucuEWSCustom("GET", "h/ip", {});
    this.kullaniciIpAdresi = responseData.IP;
  }
